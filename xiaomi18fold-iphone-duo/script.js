...
function render() {
  ...
  stage.style.setProperty("--echo-one-opacity", (closed * 0.25).toFixed(3));
  stage.style.setProperty("--echo-two-opacity", (closed * 0.13).toFixed(3));
  stage.style.setProperty("--echo-one-angle", `${closed * -142}deg`);
  stage.style.setProperty("--echo-two-angle", `${closed * -110}deg`);
